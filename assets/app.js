(function () {
  const botProfiles = {
    "ai-secretary": {
      name: "AI業務相談ボット",
      subline: "見込み客の課題を整理して商談化",
      greeting: "こんにちは。業務のどこを自動化したいか、今の状況を1つ教えてください。営業資料・FAQ・予約導線まで案内できます。",
      quick: ["料金感を知りたい", "何を自動化できる？", "導入までの流れ"],
      rules: [
        {
          keys: ["料金", "価格", "費用", "予算"],
          reply: "デモ想定では、初期設計・HP実装・チャットシナリオ作成をセット化できます。小規模なら月額保守込みで提示しやすく、商談では「問い合わせ対応時間の削減」と「24時間受付」を効果として見せます。"
        },
        {
          keys: ["自動", "できる", "業務", "faq"],
          reply: "よくある質問、資料請求、予約前ヒアリング、社内マニュアル検索、一次見積もりの整理がデモできます。最初は人が最終判断する前提にすると導入ハードルが下がります。"
        },
        {
          keys: ["流れ", "導入", "期間", "進め方"],
          reply: "流れは 1. 現状ヒアリング、2. FAQと営業導線の整理、3. HPとチャットの試作、4. 実データで調整、5. 公開です。営業では最短2週間の小さな導入例として見せられます。"
        }
      ],
      fallback: "内容を確認しました。営業デモでは、まず「問い合わせ削減」「予約増加」「資料請求増加」のどれを狙うか決めると提案がまとまります。"
    },
    salon: {
      name: "サロン予約アシスタント",
      subline: "メニュー相談から予約前確認まで",
      greeting: "ご来店前の相談を承ります。希望メニュー、来店時期、気になる悩みを入力してください。",
      quick: ["初回メニューを相談", "今日予約できますか？", "料金を知りたい"],
      rules: [
        {
          keys: ["初回", "メニュー", "相談", "おすすめ"],
          reply: "初回はカウンセリング付きのケアコースを案内します。髪質・肌質・所要時間の希望を聞いて、スタッフが確認しやすい形に整理します。"
        },
        {
          keys: ["予約", "今日", "明日", "空き"],
          reply: "このデモでは空き枠の自動確認前までを再現しています。希望日時・人数・連絡先を受け取り、スタッフ確認へつなげる設計です。"
        },
        {
          keys: ["料金", "価格", "費用"],
    ...
    reform: {
      name: "リフォーム見積もりボット",
      subline: "写真送付前の一次相談を自動化",
      greeting: "リフォーム内容を伺います。場所、築年数、困っていること、希望時期を入力してください。",
    ...
    chatbot: {
      name: "導入診断ボット",
      subline: "チャットボット導入LP用",
      greeting: "今の問い合わせ対応で困っていることを教えてください。導入優先度をその場で整理します。",
    ...
    sns: {
      name: "SNS運用診断ボット",
      subline: "投稿前の課題を整理",
      greeting: "SNS運用の状況を教えてください。投稿頻度、売りたい商品、止まっている理由から改善案を出します。",
    ...
    recruit: {
      name: "採用エントリーボット",
      subline: "応募前の不安を減らす",
      greeting: "募集内容について質問できます。職種、働き方、選考の流れなど、気になる点を入力してください。",
